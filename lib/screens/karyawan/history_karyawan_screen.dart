...
class HistoryKaryawanScreen extends StatefulWidget {
  final String name;

  HistoryKaryawanScreen({required this.name});

  @override
  _HistoryKaryawanScreenState createState() => _HistoryKaryawanScreenState();
}

class _HistoryKaryawanScreenState extends State<HistoryKaryawanScreen> {
  ...
  Future<void> fetchAbsensi() async {
    final data = await dbHelper.fetchAbsensiKaryawan(widget.name);
    setState(() {
      absensiList = data;
      isLoading = false;
    });
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(absensi['datetime']),
                    );
                  },
                ),
    );
